...
exports.account = (req, res) => {
  ...
  //   api.deleteUser(res.locals.user.rid)
  //   .then(() => {
  //     res.logout();
  //     res.status(204).json({ status: 204, data: 'Delete operation successful.' });
  //   })
  //   .catch(err => res.render('error', { status: err.status || 500, details: err.error_description || 'There was a problem deleting your account.' }));
  // }
};
