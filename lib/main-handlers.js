...
exports.blog = (req, res) => res.redirect('https://blog.digitallinguistics.org/');

exports.data = (req, res) => res.render('error', {
  error: 'Data Explorer coming soon!'
});

exports.developer = (req, res) => res.redirect('https://developer.digitallinguistics.org/');

exports.home = (req, res) => res.render('main/home');

exports.learn = (req, res) => res.redirect('http://wugbot.org');
...
exports.schemas = (req, res) => {
  if (req.params.schema) {
    res.redirect(`${process.env.SCHEMAS}/${req.params.schema}-latest.json`);
  } else {
    res.redirect('https://digitallinguistics.github.io/dlx-spec/');
  }
};
