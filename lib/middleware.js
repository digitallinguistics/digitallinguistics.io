...
exports.error500 = (err, req, res, next) => { // eslint-disable-line
  res.render('error', {
    status: 500,
    error: 'Server error',
    details: `Internal server error. Please consider opening an issue on GitHub: <a href=${package.bugs.url}>${package.bugs.url}</a>`
  });
};
...
exports.locals = (req, res, next) => {
  ...
  res.locals.cdn = 'https://digitallinguistics.blob.core.windows.net';
